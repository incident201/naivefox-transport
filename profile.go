...
var profiles = map[string]appProfile{
	...
	"continuous-bulk-interactive1": {staged20Slots, 20, 65536, false, 2, false, false, true, false, 4, true, true, "interactive"},
	"continuous-bulk-upload1":      {staged20Slots, 20, 65536, false, 2, false, false, true, false, 4, true, true, "upload"},
}
