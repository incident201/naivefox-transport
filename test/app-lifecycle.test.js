...
async function application(commit, failAction = false, realtime = false) {
  ...
  const reader = fs.readFileSync(path.join(__dirname, "../lab/browser-application/read-cell.js"), "utf8");
  const lifecycle = fs.readFileSync(path.join(__dirname, "../lab/browser-application/lifecycle.js"), "utf8");
  const source = fs.readFileSync(path.join(__dirname, "../lab/browser-application/app.js"), "utf8")
